  ...
  <div class="page">
    ...
    <div class="page__main">
      ...
      <div class="page__main__controls">
        ...
        <select 
          class="page__main__controls__select  clear_button_style"
...
let selectedSort = ref<string>('up');
let selectedFilter = ref<string>('any');
...
onBeforeMount(async () => {
  ...
  if(locStore && locStore != '[]'){
    ...
    localStorage.setItem('productList', `[
      ...
      {"id": 5,"name": "salad", "seller": "andrew", "integration": "reels"},
      ...
      {"id": 18,"name": "crabs", "seller": "max", "integration": "reels"},
      ...
      {"id": 22,"name": "wine", "seller": "john", "integration": "stories"},
      {"id": 23,"name": "water", "seller": "max", "integration": "stories"},
      {"id": 24,"name": "ham", "seller": "rey", "integration": "stories"},
      {"id": 25,"name": "lemon", "seller": "andrew", "integration": "stories"}
    ]`);
    await store.dispatch('readProductListFromStorage');
  }
});
